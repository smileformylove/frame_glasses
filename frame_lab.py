...
COMMANDS = {
    ...
    "screen-demo": "examples/screen_demo.py",
    "weather-profile": "examples/weather_profile.py",
...
DESCRIPTIONS = {
    ...
    "screen-demo": "Run a deterministic multi-card screen demo",
    "weather-profile": "Manage default weather preferences",
